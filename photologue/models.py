...
class Database(models.Model):
    date_added = models.DateTimeField(_('Дата создания'),
                                      default=now)
    ...
    slug = models.SlugField(_('slug'),
                            unique=True,
                            max_length=250,
                            help_text=_('"slug" - уникальная строка индентификатор'))
...
class CBIRIndex(models.Model):
    ...
    date_added = models.DateTimeField(_('Дата публикации'),
                                      default=now)
    title = models.CharField(_('Название'),
                             max_length=250,
                             unique=True)
    slug = models.SlugField(_('slug'),
                            ...
                            max_length=250,
                            help_text=_('"slug" - уникальная строка индентификатор'))
    name = models.CharField('Название каталога со структурами данных индекса',
                            max_length=250,
                            help_text="")
    description = models.TextField(_('Описание'),
                                   blank=True)
...
class ImageModel(models.Model):
    ...
    date_taken = models.DateTimeField(_('Дата загрузки'),
                                      null=True,
                                      blank=True,
    ...
    view_count = models.PositiveIntegerField(_('view count'),
                                             default=0,
                                             editable=False)
    crop_from = models.CharField(_('Обрезать'),
                                 blank=True,
                                 max_length=10,
                                 default='center',
